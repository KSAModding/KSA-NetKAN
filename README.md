# The KSA-NetKAN metadata repository
...
> Note: KSA support for CKAN is still under active development.

## Adding or fixing a mod

See the CKAN wiki guide on [Adding a mod to the CKAN](https://github.com/KSP-CKAN/CKAN/wiki/Adding-a-mod-to-the-CKAN), then open a pull request that adds or edits a file under `NetKAN/`.

## License

Metadata in this repository is released under CC0-1.0 (see `LICENSE`).